...
export default function Login() {
    ...
    const [errors, setErros] = React.useState<{ email?: string, password?: string }>({})
        ...
        <Box w='100%' h='100%' display='flex' alignItems='center' justifyContent='center'>
            <Card.Root w={{ base: '90%', xl: '30%', lg: '35%', md: '40%', sm: '60%' }} variant='elevated' borderRadius='xl'>
                <form onSubmit={(e) => { e.preventDefault(); handleLogin() }}>
                    <Card.Header>
                        <Heading fontSize='.9rem' fontWeight='bold' textTransform='uppercase'>Login to continue</Heading>
                    </Card.Header>
                    <Card.Body gap='1rem'>
                    ...
                    <Card.Footer flexDir='column'>
                        ...
                        <Text flexShrink='0' fontSize='.7rem' fontWeight='semibold' textTransform='uppercase'><a href='/register' style={{ color: 'blue' }}>Register</a></Text>
                    </Card.Footer>
                </form>
            </Card.Root>
        </Box>
